...
See [Tutorial: Build an agentic web app in Azure App Service with LangGraph or Foundry agent Service (Node.js)](https://learn.microsoft.com/azure/app-service/tutorial-ai-agent-web-app-langgraph-foundry-node).
